...
(function() {
    ...
    jigsaw.Jigsaw = Class.extend({
        init: function(opts) {
            ...
            this.ui = new jigsaw.UI(eventBus, 4);
        ...
        shuffle: function() {
            ...
            var i, l = T.length,
				...
				//var calcY1=parseInt((compArea*pixelRatio)+midArea+(T[0].height/2))-((T[0].height));
				
				var calcY1=(parseInt(selectedArea)+((T[0].height)/2))*pixelRatio;
				var calcY2=parseInt((compArea*pixelRatio)+midArea)-(10*pixelRatio)-((T[0].height+20));
				if(document.documentElement.clientWidth < 900){
				 width = document.getElementById("canvas").clientWidth * pixelRatio;	
				}
				//console.log("iamwidth"+document.getElementById("game-box").clientWidth);
					
				var rand_index=Math.floor(Math.random()*4),counter=0;
				
				var woffset=(((width-(T[0].width*4))/2)+T[0].width/2);	
				//var woffset=Util.randint(w) +  padx;
				
				var xx=[woffset,woffset+(T[0].width)+5,woffset+(T[0].width*2)+10,woffset+(T[0].width*3)+15];
        ...
        ce.drag("*", {
            ...
            move: function(c, e) {
                ...
                var deltaX = c.x - c.lastX,
                    ...
                    height = c.cv.height+100,
                    size = pieces[0].size;
					//console.log(c.cv.height);
			...
			var audio = new Audio('button-29.mp3');
                audio.play();
            c.remove(this);
            c._shapes.push(this)
        });
